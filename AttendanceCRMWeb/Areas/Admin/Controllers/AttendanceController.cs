...
namespace AttendanceCRMWeb.Areas.Admin.Controllers
{
    public class AttendanceController : BaseController
    {
        ...
        {
            var _res = await PrepareAction_Calendar(new CalendarVm { PageNum = 1, UrlData = "/UserManagement/EmployeeAttendance/P_Calendar", PageSize = _selectCount, FirstPage = 1 });
            return View(_res);
        }

        #region Calendar

        private async Task<viewModel<ViewModel.UserManagement.Attendance.CalendarVm>> PrepareAction_Calendar(CalendarVm model)
        {
            try
            {
                ...
                list2.CommonCustomViewTablePaging = list2.FillPageingData(list2.TLists.Count(),
                    ...
                    "/UserManagement/EmployeeAttendance/Delete_Calendar",
                    urlEdit: "",
                    tableIdDiv: "divListsCalendar",
                    urlDeleteRows: "/UserManagement/EmployeeAttendance/Delete_Calendar",
        ...
        {
            var model = await PrepareAction_Calendar(new CalendarVm { PageNum = page, UrlData = "/UserManagement/EmployeeAttendance/P_Calendar", PageSize = _selectCount, FirstPage = 1 });
        ...
        public async Task<ActionResult> P_Calendar(CalendarVm model)
        {
            try
            {
                model.UrlData = "/UserManagement/EmployeeAttendance/P_Calendar";
        ...
        private async Task<viewModel<JobTimeVm>> PrepareAction_JobTime(JobTimeVm model)
        {
            try
            {
                ...
                list2.CommonCustomViewTablePaging = list2.FillPageingData(list2.TLists.Count(),
                    ...
                    _selectCount,
                    list2.CountAll_TLists,
                    "/UserManagement/EmployeeAttendance/Delete_JobTime",
                    urlEdit: "",
                    tableIdDiv: "divListsJobTime",
                    urlDeleteRows: "/UserManagement/EmployeeAttendance/Delete_JobTime",
        ...
        {
            var model = await PrepareAction_JobTime(new JobTimeVm { PageNum = page, UrlData = "/UserManagement/EmployeeAttendance/P_JobTime", PageSize = _selectCount, FirstPage = 1 });
        ...
        public async Task<ActionResult> P_JobTime(JobTimeVm model)
        {
            try
            {
                model.UrlData = "/UserManagement/EmployeeAttendance/P_JobTime";
        ...
        private async Task<viewModel<ShiftWorkVm>> PrepareAction_ShiftWork(ShiftWorkVm model)
        {
            try
            {
                ...
                list2.CommonCustomViewTablePaging = list2.FillPageingData(list2.TLists.Count(),
                    ...
                    _selectCount,
                    list2.CountAll_TLists,
                    "/UserManagement/EmployeeAttendance/Delete_ShiftWork",
                    urlEdit: "",
                    tableIdDiv: "divListsShiftWork",
                    urlDeleteRows: "/UserManagement/EmployeeAttendance/Delete_ShiftWork",
        ...
        {
            var model = await PrepareAction_ShiftWork(new ShiftWorkVm { PageNum = page, UrlData = "/UserManagement/EmployeeAttendance/P_ShiftWork", PageSize = _selectCount, FirstPage = 1 });
        ...
        public async Task<ActionResult> P_ShiftWork(ShiftWorkVm model)
        {
            try
            {
                model.UrlData = "/UserManagement/EmployeeAttendance/P_ShiftWork";
        ...
        {
            var model = await PrepareAction_UserShift(new PubUser_ShiftVm { PageNum = page, UrlData = "/UserManagement/EmployeeAttendance/P_UserShift", PageSize = _selectCount, FirstPage = 1 });
        ...
        public async Task<ActionResult> P_UserShift(PubUser_ShiftVm model)
        {
            try
            {
                model.UrlData = "/UserManagement/EmployeeAttendance/P_UserShift";
        ...
        private async Task<viewModel<TimeRecordVm>> PrepareAction_AttLog(TimeRecordVm model)
        {
            try
            {
                ...
                list2.CommonCustomViewTablePaging = list2.FillPageingData(list2.TLists.Count(),
                    ...
                    _selectCount,
                    list2.CountAll_TLists,
                    "/UserManagement/EmployeeAttendance/Delete_AttLog",
                    urlEdit: "",
                    tableIdDiv: "divListsAttLog",
                    urlDeleteRows: "/UserManagement/EmployeeAttendance/Delete_AttLog",
        ...
        {
            var model = await PrepareAction_AttLog(new TimeRecordVm { PageNum = page, UrlData = "/UserManagement/EmployeeAttendance/P_AttLog", PageSize = _selectCount, FirstPage = 1 });
        ...
        public async Task<ActionResult> P_AttLog(TimeRecordVm model)
        {
            try
            {
                model.UrlData = "/UserManagement/EmployeeAttendance/P_AttLog";
        ...
        private async Task<viewModel<TransactionRequestVm>> PrepareAction_TransReq(TransactionRequestVm model)
        {
            try
            {
                ...
                list2.CommonCustomViewTablePaging = list2.FillPageingData(list2.TLists.Count(),
                    ...
                    _selectCount,
                    list2.CountAll_TLists,
                    "/UserManagement/EmployeeAttendance/Delete_TransReq",
                    urlEdit: "",
                    tableIdDiv: "divListsTransReq",
                    urlDeleteRows: "/UserManagement/EmployeeAttendance/Delete_TransReq",
        ...
        {
            var model = await PrepareAction_TransReq(new TransactionRequestVm { PageNum = page, UrlData = "/UserManagement/EmployeeAttendance/P_TransReq", PageSize = _selectCount, FirstPage = 1 });
        ...
        public async Task<ActionResult> P_TransReq(TransactionRequestVm model)
        {
            try
            {
                model.UrlData = "/UserManagement/EmployeeAttendance/P_TransReq";
